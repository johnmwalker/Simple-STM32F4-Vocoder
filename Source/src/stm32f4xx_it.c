...
volatile uint32_t usec_counter;
...
{
	// Decrement the timer in delay.c
	TimeTick_Decrement();
	usec_counter++;
}
...
// Note that this clicking functionality is not enabled on the STM32F407
...
void EXTI0_IRQHandler(void)
{
  ...
  { 
      ...
      //if (last_button_time + 200000 < usec_counter) {
       //   last_button_time = usec_counter;
